...
- Name: Minimal OpenClaw Novel Project
- Genre / mode: TODO
- Current status: initialized
- Current completed chapter: 0
- Current stop point: before Chapter 1

## Canon source of truth

- Canon directory: `canon/`
...
Read `skill/SKILL.md`, `WORK_QUEUE.md`, `PROJECT_INDEX.md`, and `workflow/model-routing.md` before starting. Do not rely on hidden chat memory.
